...
class DbMemo:
    ...
    @staticmethod
    def get_memo_name(author_id: int, name_part: str, exact_name: bool = False) -> Union[str, None]:
        ...
        with DatabaseConnection() as cursor:
            cursor.execute(f"""
                                ...
                                LIMIT 1
                                """,
                           {"author_id": author_id, "name_part": name_part if exact_name else name_part + "%"})
